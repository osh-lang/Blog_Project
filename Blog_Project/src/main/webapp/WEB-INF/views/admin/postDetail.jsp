...
<div class="ui borderless main menu">
  <div class="ui text container">
    ...
    <a href="${pageContext.request.contextPath}/admin/main" class="item">Home</a>
  </div>
</div>

<div class="ui main text container">
  <h1 class="ui header">${viewPost.post_sj}</h1>
    <hr>
</div>
...
<div class="ui text container">
  <p>${viewPost.frst_regist_dt} ${viewPost.frst_register}</p>
  <a href="#">#태그</a>
  <a href="#">#태그2</a>
</div>
...
<input type="hidden" id="post_no" value="${viewPost.post_no}">
...
<form class="ui form">
  ...
  <div class="ui blue button" id="insert_cmt_btn">댓글등록</div>
</form>
